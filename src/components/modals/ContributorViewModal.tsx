...
import { X, Link as Linkedin, Globe, User } from 'lucide-react';
import { SiFacebook as Facebook, SiInstagram as Instagram, SiGithub as Github } from '@icons-pack/react-simple-icons';
import { ContributorData } from '@/src/types';
