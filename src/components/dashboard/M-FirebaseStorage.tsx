...
const MFirebaseStorage = ({ isOpen, folder, onClose, onSelect, fileTypes = ['svg', 'png', 'jpg', 'jpeg', 'gif', 'webp'], title = 'Select from Firebase Storage' }: MFirebaseStorageProps) => {
