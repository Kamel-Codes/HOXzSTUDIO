...
import MContact from '../modals/ContactModal';
            ...
            <div className="glass-surface p-1.5 rounded-xl flex gap-2 overflow-x-auto shrink-0 w-fit self-center min-[960px]:self-start">
                <button
                    ...
                    className={`
                        ...
                        ${activeSection === 'bookings' ? 'bg-green-500/15 text-green-300' : 'bg-transparent text-gray-500 hover:bg-green-500/10 hover:text-green-300 dark:text-gray-400 dark:hover:text-green-400'}
                    `}
                >
                                                ...
                                                {isSelected && date && (
                                                    <motion.div
                                                        ...
                                                        style={{
                                                            ...
                                                            borderRadius: 12,
                                                            backgroundColor: 'rgb(59, 246, 134)',
                                                            boxShadow: '0 4px 12px -2px rgba(59, 246, 125, 0.5)',
                                                            zIndex: 0
                                                        }}
                                                    />
                                                )}
                                                        ...
                                                        <div className="flex gap-0.5 md:gap-1 justify-center relative z-10">
                                                            {dayMeetings.slice(0, windowWidth < 420 ? 1 : 3).map((m) => (
                                                                <div
                                                                    ...
                                                                    style={{ backgroundColor: isSelected ? 'rgba(255,255,255,0.5)' : 'rgb(59, 246, 131)' }}
                                                                />
                                                            ))}
                                                        </div>
                                                    </>
