            ...
            <LayoutGroup>
              ...
              >
                ...
                <RotatingText
                  ...
                  mainClassName="px-3 sm:px-4 md:px-5 bg-green-300 text-black overflow-hidden py-1 sm:py-2 md:py-3 justify-center rounded-2xl font-black text-4xl sm:text-5xl md:text-6xl tracking-tight"
                  staggerFrom={"last"}
                  initial={{ y: "100%", opacity: 0 }}
                  animate={{ y: 0, opacity: 1 }}
                  exit={{ y: "-120%", opacity: 0 }}
